...
void CameraModel::PixelDist2PixelUndist(const double Ud, const double Vd, double &Uu, double &Vu){
...
void CameraModel::PixelDist2ImgPlaneUndist(const double Ud, const double Vd, double &Xu, double &Yu, double &Zu){
