...
public:
    ...
    cv::Point findNeareastValueInLookupTable(float expectedValueX, float expectedValueY);
    ...
    float quadInterpolate( float expectedValue, float negPoint, float zeroPoint, float posPoint);
