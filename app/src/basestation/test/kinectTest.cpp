...
/*TEST(KinectTest, GetDistanceForRobotMatrix2) {
    ...
    Mat testMatrix = KinectUtility::readFromFile("img/testKinect/matrixRobot2.xml");
...
TEST(KinectTest, GetDistanceForRobotMatrix3) {
    ...
    Mat testMatrix = KinectUtility::readFromFile("img/testKinect/matrixRobot3.xml");
    Kinect kinect(obstacle1, obstacle2);
...
TEST(KinectTest, GetDistanceForRobotMatrix4) {
    ...
    Mat testMatrix = KinectUtility::readFromFile("img/testKinect/matrixRobot4.xml");
    Kinect kinect(obstacle1, obstacle2);
...
TEST(KinectTest, GetDistanceForRobotMatrix5) {
    ...
    Mat testMatrix = KinectUtility::readFromFile("img/testKinect/matrixRobot5.xml");
    Kinect kinect(obstacle1, obstacle2);
...
TEST(KinectTest, GetDistanceForRobotMatrix6) {
    ...
    Mat testMatrix = KinectUtility::readFromFile("img/testKinect/matrixRobot6.xml");
    Kinect kinect(obstacle1, obstacle2);
...
TEST(KinectTest, GetDistanceForRobotMatrix7) {
    ...
    Mat testMatrix = KinectUtility::readFromFile("img/testKinect/matrixRobot7.xml");
    Kinect kinect(obstacle1, obstacle2);
...
TEST(KinectTest, GetDistanceForRobotMatrix8) {
    ...
    Mat testMatrix = KinectUtility::readFromFile("img/testKinect/matrixRobot8.xml");
    Kinect kinect(obstacle1, obstacle2);
...
TEST(KinectTest, GetDistanceForRobotMatrix9) {
    ...
    Mat testMatrix = KinectUtility::readFromFile("img/testKinect/matrixRobot9.xml");
    Kinect kinect(obstacle1, obstacle2);
