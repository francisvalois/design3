...
Puisque le LM3S9B92 possède des compteurs d'usage général qui implémentent une fonction de capture d'événement, la méthode par timings a été employée. Pour l'instant, il est possible de mesurer des temps entre les transitions sur un signal interne au microcontrôleur généré par un PWM.
